...
<body>
    <h1>오늘은 <span id = "spanpink"><%@ include file="datePrint.jsp" %></span> 입니다.</h1> 
    
    <h1>피자 아카데미</h1>
    <table border = "1">
        <tr>
            <td><strong>종류</strong></td>
            <td width = "130"; align ="center"><strong>이름</strong></td>
    ...
    <form action = "/2_JSP/PizzaServlet" method = "post">
        피자 : 
        <select name = "piza">
            <option>치즈피자</option>
            <option>콤피네이션피자</option>
